...
![Initial Configuration Screen](expected/01-initial-config.png)
...
![First Player Added](expected/02-player-added.png)
...
![Second Player Added](expected/03-two-players.png)
...
![Game Started](expected/04-game-started.png)
...
![Ship Selected](expected/05-ship-selected.png)
